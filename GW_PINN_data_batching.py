...
def compute_residual_loss2(model2, t_batch2):
  t_pred = t_batch2.requires_grad_() 
...
for epoch in range(epoch_num):
  ...
  indices2 = torch.randperm(num_points)[:batch_size]
  t_batch2 = t[indices2].requires_grad_()
  residual_loss2 = compute_residual_loss2(model2, t_batch2)
